...
class _SelectTopicScreenState extends ConsumerState<SelectTopicScreen> {
        ...
        appBar: HoohAppBar(
          ...
          actions: [
            ...
            TextButton(
                ...
                child: Text(
                  globalLocalizations.common_done,
                ))
          ],
          ...
          children: [
              ...
              child: RawKeyboardListener(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: globalLocalizations.select_topic_hint,
                    prefixIcon: Padding(
                    ...
                    hintStyle: TextStyle(fontSize: 14, color: designColors.light_06.auto(ref).withOpacity(0.5)),
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Text(
                  sprintf(globalLocalizations.select_topic_max_tag_limit_helper_text, [SelectTopicScreenViewModel.MAX_SELECTED_TAGS]),
                  style: TextStyle(fontSize: 12, color: designColors.feiyu_blue.auto(ref)),
                ),
              ),
            ),
            Visibility(
              visible: modelState.userTags.isNotEmpty,
              child: Row(
                children: [
                  Expanded(
                    child: Container(
  ...
  void addTag(String tag) {
    ...
    if (modelState.userTags.length >= SelectTopicScreenViewModel.MAX_SELECTED_TAGS) {
      showSnackBar(context, sprintf(globalLocalizations.select_topic_reach_max_tag_limit, [SelectTopicScreenViewModel.MAX_SELECTED_TAGS]));
      return;
    }
    SelectTopicScreenViewModel model = ref.read(widget.provider.notifier);
    model.addTag(
