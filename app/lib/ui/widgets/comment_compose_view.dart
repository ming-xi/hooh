...
class _CommentComposeViewState extends ConsumerState<CommentComposeView> {
                ...
                child: Container(
                  ...
                  child: KeyboardListener(
                    ...
                    child: TextField(
                      ...
                      style: TextStyle(color: designColors.dark_01.auto(ref), fontSize: 14),
                      decoration: InputDecoration(
                        ...
                        contentPadding: EdgeInsets.symmetric(horizontal: 10, vertical: 7.5),
                        isDense: true,
                        hintStyle: TextStyle(color: designColors.light_06.auto(ref), fontSize: 14),
  ...
  void sendComment(CommentComposeWidgetModelState modelState, CommentComposeWidgetViewModel model, BuildContext context) {
  ...
  List<Widget> buildButtons() {
    CommentComposeWidgetModelState modelState = ref.watch(widget.provider);
    CommentComposeWidgetViewModel model = ref.read(widget.provider.notifier);
    bool visible = ref.watch(globalKeyboardVisibilityProvider);
    if (visible) {
      return [
        SizedBox(
          width: 32,
          ...
          child: Material(
            ...
            child: Ink(
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(10), color: modelState.canSend ? designColors.feiyu_blue.auto(ref) : designColors.light_02.auto(ref)),
              child: InkWell(
                onTap: !modelState.canSend
                    ? null
                    : () {
                        sendComment(modelState, model, context);
                      },
                ...
                child: Center(
                  child: HoohIcon(
                    "assets/images/ic_submit_content.svg",
                    width: 12,
                    color: modelState.canSend ? designColors.light_01.auto(ref) : designColors.light_06.auto(ref),
                  ),
                ),
              ),
            ),
